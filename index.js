...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6283843251769@s.whatsapp.net"] // GANTI NOMOR LU
			const adminbotnumber = ["6283834251769@s.whatsapp.net"] // GANTI NOMOR LU
			const frendsowner = ["6283843251769@s.whatsapp.net"] // GAUSAH DIGANTI!!!
			...
			switch(command) {
				...
				case 'info':
					...
					teks = `➽ *Nama Bot* : _${me.name}_\n➽ *Nomer Bot* : _@${me.jid.split('@')[0]}_\n➽ *prefix* : _${prefix}_\n➽ *Total Block* : _${blocked.length}_\n➽ *Aktif Sejak* : _${kyun(uptime)}_\n➽ *Instagram* : https://www.instagram.com/villosmile_\n➽ *YouTube* : https://youtube.com/channel/UCCeAtBsjm52sj6-h3DTW45A\n➽ *Script By* : _villopratama_ [vrx]\n➽ *Note* : _Ini SC pribadi no minta SC_\n➽ *Sepecial Thangks To* :\n➽ _Allah SWT_ \n➽ _MahankBarBar_ \n➽ _Seluruh member *pejuang senyum*_\n➽ _villopratama_\n➽ _MahankBarbar_\n➽ _Affis_\n➽ _Anang_\n➽ _Bryan_\n➽ _Bagas_\n➽ _Ntaa_\n➽ _XP-TN_\n➽_YUKINIKO_\n_DLL_`
			...
			case 'owner':
				...
				case 'fake':          
                    ...
                    break
                case 'fakereplay':
                   client.reply(from, 'ange mas', 'mending lari', "0838-43251769")
                   break
                case 'but':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'report':
                    ...
                    client.sendMessage('6283843251769@s.whatsapp.net', options, text, {quoted: mek})
               ...
               case 'infogempa':
			    ...
			    case 'otagall':
					...
					mentions('╔══✪〘 Mention All 〙✪══'+teks+'╚═〘 vrx 〙', members_id, true)
					break
				case 'clearall':
					if (!isOwner) return reply('Kamu siapa?')
				...
				//frendowner
				case `addadmin`:
                   if (!isOwner) return reply('Perintah ini hanya bisa di gunakan oleh Owner villopratama!', id)
